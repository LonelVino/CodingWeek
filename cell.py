class Cell(object):
    ...
    pheromone
        Float, meaningful only to OTHER, the total level of pheromone
    food_amount
        Float, meaningful only to FOOD, the total amount of food
    '''
    ...
    def __init__(self, position_y, position_x, ants=set(), type_of_cell=OTHER):
        '''
    ...
    def distance_to(self, another_Cell):
        '''
        ...
        -------
        distance
            Integer of distance between the two cells
        '''
        x = another_Cell.position_x - self.position_x
        y = another_Cell.position_y - self.position_y
